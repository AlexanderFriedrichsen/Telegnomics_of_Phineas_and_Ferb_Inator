...
def get_lines_words_data(main_characters):
    ...
    for season in range(0, 4):
        ...
        for episode in script_paths[season]:
            script = open(episode, 'r', encoding="utf-8")
...
def plot_lines_words(most_lines, most_words, line_length):
    ...
    plt.savefig("figures/lines_spoken_by_character")
    plt.figure(2)
    ...
    plt.savefig("figures/words_spoken_by_character")
    plt.figure(3)
    ...
    plt.savefig("figures/average_words_per_line")
    plt.show()
